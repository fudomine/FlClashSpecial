...
- adjust the sequence of settings

## v0.8.90c

- delete repeated color

- update color

- update color

- optimize windows UI and delete about page content

- optimize windows UI and delete about page content

- change defaultPrimaryColor

- change defaultPrimaryColor &delete pureBlack

- hide connection&checkupdateitem label
...
- update flutter generated

- Remove Go mod tidy step from build workflow

- Removed 'Go mod tidy before build' step from workflow.
...
- optimize setting default value
